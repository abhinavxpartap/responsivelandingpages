...
import iphone from "../image/iP14.png"
import star from "../image/Starblack.png"
...
const Section5: React.FC<sect5> = (props) => {
  const {title,desc,Mobile,starimg} = props
  return (
    <div className="lg:pt-[140px] pt-[60px] lg:pb-[120px] pb-[50px]">
    <div className='flex flex-col max-w-[1062px] mx-auto gap-[50px] items-center px-[20px] pb-[30px] '>
        {/* headinng  */}
        <h1 className='text-[#333333] font-semibold font-Montserrat not-italic 
        ...
        {/* middle cont */}
        <div className="max-w-[1061.5px] w-full h-full max-h-[667.7px] mx-auto items-center relative flex shrink-0 ">            
        <div className="max-w-[323.883px] max-h-[656.43px] mx-auto z-50 ">
         ...
         <div className="max-w-[500px] w-full h-full max-h-[500px] mx-auto rounded-[500px] opacity-[0.37] bg-[#DDC686] blur-[163.1304931640625px] absolute top-[5%] right-[26%] self-center -z-1"/>  
         {/* star div */}
        ...
        {/* last cont */}
        <h4 className='font-medium not-italic max-w-[617px] mx-auto text-center font-Montserrat text-[18px] text-[#333333] leading-[30px] capitalize '>
        {desc}    
       </h4>
    </div>
    </div>
